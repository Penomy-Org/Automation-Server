...
using AT_Api_0002.Mapper;
using AT_Api_0002.Models;
using AT_Api_0002.Presentation.Filters.SetStateBag;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace AT_Api_0002.Presentation;
...
public sealed class Endpoint : ControllerBase
{
    ...
    public async Task<IActionResult> ExecuteAT_Api_0002Async(
