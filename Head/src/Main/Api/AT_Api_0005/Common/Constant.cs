...
using AT_Api_0005.Presentation;
using Microsoft.AspNetCore.Http;

namespace AT_Api_0005.Common;

public static class Constant
{
    public const string CONTROLLER_NAME = "AT_Api_0005Endpoint";

    public const string ENDPOINT_PATH = "AT_Api_0005";
