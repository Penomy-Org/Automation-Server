...
using AT_Api_0004.Presentation;
using Microsoft.AspNetCore.Http;

namespace AT_Api_0004.Common;

public static class Constant
{
    public const string CONTROLLER_NAME = "AT_Api_0004Endpoint";

    public const string ENDPOINT_PATH = "AT_Api_0004";
